...
internal class Program
{
    ...
    {
        var Customers = from Customer in XElement.Load(@"C:\Users\user\Desktop\DotNet\Practice\CustomerAppLINQ\CustomerAppLINQ\CustomerData.xml").Elements()
    ...
    {
        var Employees = from Employee in XElement.Load(@"C:\Users\user\Desktop\DotNet\Practice\CustomerAppLINQ\CustomerAppLINQ\EmployeeData.xml").Elements()
    ...
    {
        var Products = from Product in XElement.Load(@"C:\Users\user\Desktop\DotNet\Practice\CustomerAppLINQ\CustomerAppLINQ\ProductData.xml").Elements()
    ...
    {
        var orders = from order in XElement.Load(@"C:\Users\user\Desktop\DotNet\Practice\CustomerAppLINQ\CustomerAppLINQ\OrderData.xml")
                                         .Elements("order")
                     select new Order
                     {
